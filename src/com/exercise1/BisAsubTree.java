 ...
 * 再判断右子树和tree2是否相同
 * 3、注意null的条件，HasSubTree中，如果两棵树都不为空才进行判断， DoesTree1HasTree2中，如果Tree2为空，则说明第二棵树遍历完了，即匹配成功，
 * tree1为空有两种情况
...
public class BisAsubTree {
	...
	/**
	 * 判断root1中是否含有root，则递归判断 
	 * 1.如果root1 == null,root2!=null，这时候root1已经没有了，但是root还有，显然root2不包含在root1中 
	 * 2.root2 == null,这时是root没有了，说明root2中的节点一个一个的匹配root1的节点（顺序也一致），说明root2包含在root1中
